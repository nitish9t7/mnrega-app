...
package dev.galaxius.mnrega.simpleapp.view.login
...
import dev.galaxius.mnrega.simpleapp.databinding.LoginFragmentBinding
...
import dev.galaxius.mnrega.view.viewmodel.LoginViewModel

@AndroidEntryPoint
class LoginFragment : BaseFragment<LoginFragmentBinding, LoginState, LoginViewModel>() {

    override val viewModel: LoginViewModel by hiltMnregaMainNavGraphViewModels()
    ...
    private fun navigateToNotesScreen() {
        findNavController().navigate(R.id.action_loginFragment_to_attendancesFragment)
    }
